...
```
variableGroups: 
    - ffc-sfd-customer-receiver-messages-snd1
    - ffc-sfd-customer-receiver-messages-snd2
    - ffc-sfd-customer-receiver-messages-snd3
variables:
    - ffc-sfd-customer-receiver-messages-APPINSIGHTS-CONNECTIONSTRING
```
